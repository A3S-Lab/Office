...
bookmark-backed PAGEREF field kind/instruction/target identity, XE index
entry plus INDEX column identity, and TOC level/hyperlink options plus
cached entry title identity in addition to v1 bookmarks/links, track
