...
Version `0.201.0` paints celticKnotwork art borders in document PDF export:

- **`celticKnotwork` art borders** — Writer `celticKnotwork` paragraph borders
  paint as repeating interlaced diamond motifs along the measured edge.
