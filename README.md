...
Version `0.205.0` paints checkedBarBlack art borders in document PDF export:

- **`checkedBarBlack` art borders** — Writer `checkedBarBlack` paragraph
  borders paint as repeating checkered bar segments along the measured edge.
