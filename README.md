...
Version `0.272.0` grows the permanent R0 no-clobber corpus gate:

- Complex (`fldChar`) header PAGE and footer NUMPAGES live field identity now
  joins `fldSimple` page-chrome fields, rich-text content controls,
