...
Version `0.200.0` paints candyCorn art borders in document PDF export:

- **`candyCorn` art borders** — Writer `candyCorn` paragraph borders paint as
  repeating candy-corn triangles along the measured edge.
