...
Version `0.278.0` grows the permanent R0 no-clobber corpus gate:

- Distinct even-page vs default header and footer text identity now joins
  first-page chrome, complex SECTION fields, page-chrome PAGE/NUMPAGES/DATE/TIME
