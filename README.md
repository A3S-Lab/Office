...
| --- | --- | --- |
| Text, paragraphs, lists, and styles | **Supported** — structured editing, native all-caps and small-caps effects, all 18 native DOCX underline values with direct or theme color identity, formatting revisions, clipboard, format painter, and undo/redo | Mature authoring with a broader long-tail style and typography catalog |
