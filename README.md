...
Version `0.199.0` paints cakeSlice art borders in document PDF export:

- **`cakeSlice` art borders** — Writer `cakeSlice` paragraph borders paint as
  repeating cake-slice wedges along the measured edge.
