...
6. Browser document PDF output toward searchable text, broader vector paint,
   ...
   highlight+shadow offsets through `0.157.0`; full PDF/UA certification and
   art borders remain open.
...
- Move browser document PDF output toward searchable text, vector content, and
  ...
  **Partial**: Latin vector paint + title/`lang`/heading outline bootstrap are
  ...
  offsets through `0.157.0`; optional host `registerWorkPdfCjkFont` TrueType
  enables searchable CJK vector text; full PDF/UA certification, art borders,
  and bundled CJK fonts remain open.
