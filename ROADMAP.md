...
6. Browser document PDF output toward searchable text, broader vector paint,
   ...
   explicit sine polylines through `0.156.0`; full PDF/UA certification and
   art/3D borders remain open.
...
- Move browser document PDF output toward searchable text, vector content, and
  ...
  **Partial**: Latin vector paint + title/`lang`/heading outline bootstrap are
  ...
  sine polylines through `0.156.0`; optional host `registerWorkPdfCjkFont`
  TrueType enables searchable CJK vector text; full PDF/UA certification,
  art/3D borders, and bundled CJK fonts remain open.
