...
Tip reviewed against `@a3s-lab/office@0.140.0`. Use this section as the active
...
- Treat bounded character, paragraph-formatting, ordered-list numbering,
  ...
  through `0.140.0`. Floating anchors, empty or malformed drawings, unresolved
