...
| Cell formatting, number formats, alignment, wrapping, borders, merge/center | **Partial**, with explicit General, Number, CNY Currency, Accounting, Percentage, Short Date, Time, Scientific, Fraction, and Text presets plus seven WPS/Excel formatting shortcuts and exact XLSX code round trips | Custom conditional sections, broader locale/currency choices, advanced border cases, rich text, and themes can normalize | P0/P1 |
