...
Tip reviewed against `@a3s-lab/office@0.152.0`. Use this section as the active
...
6. Browser document PDF output toward searchable text, broader vector paint,
   ...
   art/wave/3D borders and full PDF/UA structure trees remain open.
...
- Move browser document PDF output toward searchable text, vector content, and
  ...
  **Partial**: Latin vector paint + title/`lang`/heading outline bootstrap are
  ...
  `0.152.0`; optional host `registerWorkPdfCjkFont` TrueType enables searchable
  CJK vector text; art/wave/3D borders, full PDF/UA structure trees, and
