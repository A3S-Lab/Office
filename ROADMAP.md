...
- Move browser document PDF output toward searchable text, vector content, and
  ...
  **Partial**: Latin vector paint + title/`lang`/heading outline bootstrap are
  ...
  through `0.158.0`; optional host `registerWorkPdfCjkFont` TrueType
  enables searchable CJK vector text; full PDF/UA certification, remaining
  decorative art borders, and bundled CJK fonts remain open.
