...
Tip reviewed against `@a3s-lab/office@0.153.0`. Use this section as the active
...
6. Browser document PDF output toward searchable text, broader vector paint,
   ...
   bootstrap through `0.153.0`; art/wave/3D borders and a full PDF/UA
   structure tree remain open.
...
- Move browser document PDF output toward searchable text, vector content, and
  ...
  **Partial**: Latin vector paint + title/`lang`/heading outline bootstrap are
  ...
  tagged bootstrap through `0.153.0`; optional host `registerWorkPdfCjkFont`
  TrueType enables searchable CJK vector text; art/wave/3D borders, a full
  PDF/UA structure tree, and bundled CJK fonts remain open.
