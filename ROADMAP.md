...
Tip reviewed against `@a3s-lab/office@0.135.0`. Use this section as the active
...
- Treat bounded character, paragraph-formatting, ordered-list numbering,
  ...
  neighbors are admitted through `0.135.0`. Floating anchors, empty or
  malformed drawings, unresolved embeds, table-spanning move-range sandwiches,
  remaining complex numbering edge cases, and broader Compare move-range
  generation remain explicit follow-up work. Relationship-free `w:tblPrChange` with a prior `w:jc`
