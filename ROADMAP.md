...
- Treat bounded character, paragraph-formatting, ordered-list numbering,
  ...
  cantSplit/repeat-header/row-height/hidden/alignment edits, and native export.
