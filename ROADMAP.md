...
Tip reviewed against `@a3s-lab/office@0.130.0`. Use this section as the active
...
- Treat bounded character, paragraph-formatting, ordered-list numbering,
  ...
  `0.130.0`. Drawings and relationship-bound hyperlinks in mixed
  paragraph-mark content, cross-section/table-spanning
