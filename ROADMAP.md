...
- Treat bounded character, paragraph-formatting, ordered-list numbering,
  ...
  breaks, tabs, carriage returns, last-rendered page breaks, page-number and date-field glyphs, non-breaking and soft hyphens, relationship-free internal
  ...
  author and date are admitted, including soft breaks, tabs, carriage returns, last-rendered page breaks, page-number and date-field glyphs, non-breaking and
  ...
  `docx.revisions.move-range`. Soft breaks, tabs, carriage returns, last-rendered page breaks, page-number and date-field glyphs, non-breaking and soft hyphens, relationship-free internal
