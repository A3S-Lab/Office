...
Tip reviewed against `@a3s-lab/office@0.143.0`. Use this section as the active
...
- Treat bounded character, paragraph-formatting, ordered-list numbering,
  ...
  malformed originals stay fail-closed. Floating anchors, empty or malformed
  drawings, unresolved embeds, residual deeper / beside-move / SDT+nested
  move-range edges, and remaining complex numbering edge cases remain
