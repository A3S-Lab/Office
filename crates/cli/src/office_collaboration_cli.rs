...
const HELP: &str = concat!(
    ...
    */
    ...
    "Document, Markdown, Spreadsheet, Presentation, and PDF find list 1-based matches. Pass matchCount as expectedMatches and optional occurrence to document-replace-text, markdown-replace-text, or presentation-replace-text. Markdown may also pass the hit indexUtf16. Spreadsheet hits name the cell for spreadsheet-set-cell. PDF hits return fieldId for pdf-set-form-value, or annotationId/pageIndex for FreeText pdf-update-annotation. PDF form values and FreeText annotations may also pass the hit indexUtf16 and matched search so only that span is replaced.\n",
