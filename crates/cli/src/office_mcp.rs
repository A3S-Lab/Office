...
impl NativeOfficeMcpServer {
    ...
    #[tool(
        ...
        description = "List 1-based text matches in a durable Document or Markdown replica without writing. Use matchCount as expectedMatches and occurrence with document-replace-text or markdown-replace-text.",
        annotations(
            read_only_hint = true,
            destructive_hint = false,
            idempotent_hint = true,
