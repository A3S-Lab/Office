...
impl NativeOfficeMcpServer {
    ...
    #[tool(
        ...
        description = "Idempotently apply one authorized format-aware Office collaboration mutation; supports Markdown UTF-16 edits and fail-closed Document text, nested paragraph, and option edits",
        annotations(
            read_only_hint = false,
            destructive_hint = false,
            idempotent_hint = true,
