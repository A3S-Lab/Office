...
impl NativeOfficeMcpServer {
    ...
    #[tool(
        ...
        description = "Idempotently apply one authorized format-aware Office collaboration mutation; supports Markdown UTF-16 edits, fail-closed Document text/paragraph/options, Spreadsheet cells, Presentation scene elements, PDF form values, and append-only PDF redaction/page-operation review",
        annotations(
            read_only_hint = false,
            destructive_hint = false,
            idempotent_hint = true,
