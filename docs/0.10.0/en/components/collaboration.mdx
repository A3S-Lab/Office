...
| --- | --- | --- | --- |
| Document | ProseMirror structure, options, comments, text and character-formatting revisions, final decisions, and sources | Text caret and selection | Text, paragraphs, page color, track changes, selection comments, attributed text suggestions, and atomic text-suggestion decisions; Yrs also validates formatting revisions and reads their audit records |
...
**体验格式修订**, open **审阅**, then **查看修订（1）**; the deterministic
A3S Test scenario also proves that rejection preserves the text while removing
the bold and revision marks.
