...
| --- | --- | --- | --- |
| Document | ProseMirror 结构、页面选项、评论、文字与字符格式修订、最终决定和参考文献 | 文本光标与选区 | 文本替换、段落增删、页面颜色、修订模式、选区评论、署名文字建议与原子文字建议决定；Yrs 还会校验格式修订并读取其审计记录 |
...
**审阅**、**查看修订（1）**；确定性 A3S Test 场景还会证明拒绝后文字保留，粗体和
修订 Mark 消失。
