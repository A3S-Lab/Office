...
| Spreadsheet | Sheets, names, native table records, and conflict-local cells | Sheet, ranges, and active cell | Cell create, update, and delete; closed table add/set/remove is available for native files, while browser co-editing table changes use the browser binding |
