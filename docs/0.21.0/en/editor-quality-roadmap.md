...
The twenty-third slice completes the frequent WPS font-size and border
...
Home and Font now uses a WPS-style split control for none, single, double,
...
The twenty-fifth slice completes common WPS text orientation and row/column
...
The twenty-sixth slice completes common direct-color absence states and WPS
