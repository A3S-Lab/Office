...
scale, spacing, kerning, emphasis, or position restores the captured selection
and creates one transaction and one Undo record.
...
highlight, character scale, spacing, kerning threshold, emphasis mark, hidden text, baseline position,
