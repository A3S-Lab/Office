...
The References ribbon inserts and refreshes typed tables of contents, captions,
cross-references, footnotes, endnotes, page fields, dates, and citations in the
controlled TipTap document. Caption
