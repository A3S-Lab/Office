...
rules are omitted rather than emitted. Complete totals-row authoring, slicers,
external/query tables, and advanced table integrations remain explicit
boundaries; their presence must not be interpreted as complete Excel or
Traditional Office table parity.
