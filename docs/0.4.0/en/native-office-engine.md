...
Document, and PDF operations, checkpoint, replay, leave, and consume a
resumable durable event cursor. The CLI provides both a JSONL watch
...
list, and section operations and review operations, typed Spreadsheet/
Presentation mutations, PDF signatures, durable comment/suggest authorization,
and native presence projection remain later milestones.
