...
# Prefer a typed operation for local Markdown, Document, Spreadsheet, or PDF
# changes. The mutation can also come from --mutation-input <file>; Markdown
# splice offsets are UTF-16 code units.
...
have typed native mutations. Richer Document review/structure mutations,
typed Spreadsheet and Presentation mutations, PDF signatures, and native
