...
dash-dot line styles alongside color, width, typed none/triangle/stealth/
diamond/oval/open endpoint arrows, layout, offsets, and endpoint percentages.
One typed line-style or arrow-style value drives the live SVG, Undo/Redo,
compact-ribbon controls, and native DrawingML `a:prstDash`, `a:headEnd`, and
`a:tailEnd` export.
...
values normalize to none). Unsupported routed connectors, long-tail dash or
arrow styles, mixed
