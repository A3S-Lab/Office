...
PDF. It currently exposes 56 deterministic ACL contracts and 47 visual
...
gradients, and pattern fills, plus Spreadsheet phone task-pane and context-menu
workflows, Presentation IME/large-window, phone chart-pane and comments-review
