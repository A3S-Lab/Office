...
PDF. It currently exposes 60 deterministic ACL contracts and 51 visual
contracts. Writer includes character position, scale, spacing, emphasis, hidden
text, OpenType, content controls, review conflicts, paired move revisions, and
phone track changes; Spreadsheet includes AutoSum, Paste Special, conditional
...
gradients, and pattern fills, plus Spreadsheet phone task-pane, context-menu,
Find, worksheet-rename, hyperlink, and advanced-underline workflows, Presentation IME/large-window, phone chart-pane and comments-review
