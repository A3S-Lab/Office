...
The native typed mutation enum does not yet contain Document suggestion-create
or suggestion-decision operations. CLI/MCP replicas can receive and relay the
resulting browser Yjs state, but agents should not construct private
ProseMirror/Yjs marks to bypass the closed typed boundary.
