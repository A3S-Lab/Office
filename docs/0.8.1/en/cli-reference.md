...
```
The Spreadsheet variants are `spreadsheet-set-cell` and
`spreadsheet-delete-cell`. Both use a stable `sheetId` plus zero-based `row`
and `column` coordinates within Excel's 1,048,576 by 16,384 grid. Set compares
