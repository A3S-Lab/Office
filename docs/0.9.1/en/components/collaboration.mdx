...
| --- | --- | --- | --- |
| Document | ProseMirror structure, options, comments, attributed suggestions, final decisions, and sources | Text caret and selection | Text, paragraphs, page color, track changes, selection comments, attributed suggestions, and atomic final decisions |
