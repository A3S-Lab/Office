...
and do not subtract the same space again. Browser PDF composition still uses
its explicit page descriptors and remains the next consumer to move onto this
live pagination result.
