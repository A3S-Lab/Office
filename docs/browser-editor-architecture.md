...
annotation tools, annotation color defaults and selected-annotation updates,
annotation deletion, history, and copy export through public plugin
capabilities. It contains no shadow-DOM queries, private viewer selectors,
label inference, or synthetic clicks. Existing PDF password handling remains
in the PDF document lifecycle rather than the removed toolbar. Annotation
opacity and stroke controls, form-authoring controls, redaction review, page
