...
PDF. It currently exposes 54 deterministic ACL contracts and 45 visual
...
gradients, and pattern fills, plus Presentation IME/large-window, phone
chart-pane, and comments-review workflows and PDF large-file workflows.
