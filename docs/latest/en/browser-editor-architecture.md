...
1. The Office shell owns the ribbon, status bar, dialogs, keyboard routing,
   ...
   Data, and owns F9 workbook recalculation in the root-scoped keyboard
    ...
    semantics without making vendor DOM text the command contract. The catalog
    is the source of truth for labels, locations, and shortcut metadata; typed
