...
| Awareness | One controller owns the `a3sOffice` field and exposes validated actor, mode, activity, and format-specific location snapshots. Providers synchronize it; participant UI and collaborative cursors are the next projection layer. |
