...
are dropped; generated image geometry and media stay authoritative. Passive
extensions also follow uniquely matched, unchanged paragraphs and their
...
stay authoritative. Unsupported run, table, note, comment, and other inline
markup may still normalize. Source font-table metadata and source-only internal
