...
highlight, character spacing, all-caps and small-caps effects, and Word grid state. Formatting
applied to text that is still a pending insertion remains part of that insertion
