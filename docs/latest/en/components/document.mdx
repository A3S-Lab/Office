...
formatting starts at 12 points. Scale, spacing, kerning, and baseline position
track mixed selections independently and commit together through one
...
highlight, character scale, spacing, kerning threshold, baseline position,
