...
Mixed or relationship-bound content, multiple body wrappers, mismatched
kind/author/date, malformed or namespace-spoofed attributes, unsupported nodes,
and over-limit input stay on the structural compatibility path with explicit
diagnostics.
