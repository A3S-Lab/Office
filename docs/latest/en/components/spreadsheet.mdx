...
not contain, begins with, ends with, greater/greater-or-equal,
...
manual. Same-column two-clause AND/OR, wildcard authoring, Top/Bottom and
dynamic evaluation, and table/AutoFilter-integrated custom sorting remain
explicit boundaries.
