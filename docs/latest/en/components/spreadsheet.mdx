...
patterns. Focused Rstest covers import, Canvas ordering, Format Painter, Paste
...
compact Canvas pixel evidence. The deterministic
`tests/e2e/spreadsheet-pattern-fill.acl` suite captures screenshots,
accessibility, console, and page errors through the local A3S Test 1.0.0 gate;
GitHub Actions and Pages do not install or invoke A3S Test.
...
90°, and 135° examples plus two path gradients. Focused Rstest covers import,
...
and compact Canvas pixel evidence. The deterministic
`tests/e2e/spreadsheet-gradient-fill.acl` suite captures screenshots,
accessibility, console, and page errors through the local A3S Test 1.0.0 gate;
GitHub Actions and Pages do not install or invoke A3S Test.
