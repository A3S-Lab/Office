...
Spreadsheet chrome is `zh-CN`; host-selected currencies, locale-specific dates,
combined date-time presets, and arbitrary custom-format authoring remain future
compatibility work. Imported unmodeled codes stay visible as Custom and are not
silently replaced.
