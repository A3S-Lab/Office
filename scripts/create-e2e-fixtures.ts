...
function wordTableStyleFixtureXml(): string {
  return [
    ...
    '</w:tcPr><w:pPr><w:jc w:val="center"/><w:spacing w:after="0"/><w:keepNext/></w:pPr>',
    '<w:rPr><w:b/><w:color w:themeColor="lt1"/></w:rPr>',
    '</w:tblStylePr>',
    '</w:style>',
    ...
    '</w:tcPr><w:pPr><w:jc w:val="right"/><w:ind w:right="180"/></w:pPr>',
