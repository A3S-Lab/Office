 ...
 */
export function normalizeDocumentCnfStyle(value: unknown): string | null {
...
export function parseDocxCnfStyleElement(element: Element): string | null {
  ...
  return normalizeDocumentCnfStyle(attribute(element, 'val'));
}
