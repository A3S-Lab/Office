 ...
 * rtlGutter, document-grid, line-number (lnNumType), and/or page-number
 * (pgNumType) edits become reviewable `section-formatting` revisions. Companion `pageGeometry` / `pageSize`
