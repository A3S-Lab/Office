 ...
 * (pgNumType), formProt, noEndnote, verticalAlign, textDirection, bidi, and/or footnotePr edits become reviewable `section-formatting` revisions. Companion `pageGeometry` / `pageSize`
