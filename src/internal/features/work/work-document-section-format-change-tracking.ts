 ...
 * (pgNumType), formProt, noEndnote, verticalAlign, textDirection, bidi, footnotePr, and/or endnotePr edits become reviewable `section-formatting` revisions. Companion `pageGeometry` / `pageSize`
