      ...
      if (supportedRowFormattingRevisionCount) {
        issues.push(
          issue(
            ...
            `${supportedRowFormattingRevisionCount} relationship-free w:trPrChange record(s) with a prior cantSplit, tblHeader, trHeight, hidden, and/or jc snapshot remain reviewable in Work as row-formatting changes and round-trip as native w:trPrChange records.`,
            'info',
          ),
        );
      }
      if (supportedCellFormattingRevisionCount) {
        issues.push(
          issue(
            ...
            `${supportedCellFormattingRevisionCount} relationship-free w:tcPrChange record(s) with a prior vAlign, solid direct-color shd, tcMar, tcW, noWrap, textDirection, and/or tcFitText snapshot remain reviewable in Work as cell-formatting changes and round-trip as native w:tcPrChange records.`,
            'info',
          ),
        );
      }
      ...
      if (preservableRowPropertyRevisionCount) {
        issues.push(
          issue(
            ...
            `${preservableRowPropertyRevisionCount} relationship-free w:trPrChange record(s) outside the reviewable cantSplit/tblHeader/trHeight/hidden/jc subset round-trip as opaque row metadata on untouched rows. They are not yet reviewable in Work; relationship-bound or spoofed records stay fail-closed. cantSplit, tblHeader, trHeight, hidden, and/or jc records are reported separately as reviewable row-formatting revisions.`,
            'info',
          ),
        );
      }
      if (preservableCellPropertyRevisionCount) {
        issues.push(
          issue(
            ...
            `${preservableCellPropertyRevisionCount} relationship-free w:tcPrChange record(s) outside the reviewable vAlign/solid-shd/tcMar/tcW/noWrap/textDirection/tcFitText subset round-trip as opaque cell metadata on untouched cells. They are not yet reviewable in Work; relationship-bound or spoofed records stay fail-closed. vAlign, solid-shd, tcMar, tcW, noWrap, textDirection, and/or tcFitText records are reported separately as reviewable cell-formatting revisions.`,
            'info',
          ),
        );
      }
