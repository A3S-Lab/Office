      ...
      if (preservableSectionPropertyRevisionCount) {
        issues.push(
          issue(
            ...
            `${preservableSectionPropertyRevisionCount} relationship-free w:sectPrChange record(s) outside the reviewable orientation/page-geometry/page-margin/paper-source/equal-width-cols/unequal-width-cols/titlePg/rtlGutter/docGrid/lnNumType/pgNumType subset round-trip as opaque section metadata on untouched sections. They are not yet reviewable in Work; relationship-bound or spoofed records stay fail-closed. Orientation, full page-geometry, page-margin, paper-source, equal-width column, unequal-width column, titlePg, rtlGutter, docGrid, lnNumType, and/or pgNumType records are reported separately as reviewable section-formatting revisions.`,
            'info',
          ),
        );
      }
