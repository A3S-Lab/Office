      ...
      if (supportedRowFormattingRevisionCount) {
        issues.push(
          issue(
            ...
            `${supportedRowFormattingRevisionCount} relationship-free w:trPrChange record(s) with a prior cantSplit, tblHeader, trHeight, hidden, jc, gridBefore, gridAfter, wBefore, and/or wAfter snapshot remain reviewable in Work as row-formatting changes and round-trip as native w:trPrChange records.`,
            'info',
          ),
        );
      }
      ...
      if (preservableRowPropertyRevisionCount) {
        issues.push(
          issue(
            ...
            `${preservableRowPropertyRevisionCount} relationship-free w:trPrChange record(s) outside the reviewable cantSplit/tblHeader/trHeight/hidden/jc/gridBefore/gridAfter/wBefore/wAfter subset round-trip as opaque row metadata on untouched rows. They are not yet reviewable in Work; relationship-bound or spoofed records stay fail-closed. cantSplit, tblHeader, trHeight, hidden, jc, gridBefore, gridAfter, wBefore, and/or wAfter records are reported separately as reviewable row-formatting revisions.`,
            'info',
          ),
        );
      }
