 ...
 * `apples` / `vine` / `archedScallops` / `babyPacifier` / `basicBlackSquares` / `basicWhiteSquares` /
 ...
 * moons/bats/birds/cabins/apples/vine/archedScallops/babyPacifier/basicSquares/basicDots/
