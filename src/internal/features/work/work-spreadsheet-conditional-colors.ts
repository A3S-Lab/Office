...
export function parseSpreadsheetConditionalColor(
  value: string,
): SpreadsheetConditionalRgbColor | null {
...
export function spreadsheetConditionalCssColor(
  color: SpreadsheetConditionalRgbColor,
): string {
  return `rgb(${color.red}, ${color.green}, ${color.blue})`;
}

export function spreadsheetConditionalRatio(
  value: number,
  minimum: number,
  maximum: number,
): number {
