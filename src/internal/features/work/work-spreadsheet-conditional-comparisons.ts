...
export type SpreadsheetConditionalComparisonOperator =
  (typeof SPREADSHEET_CONDITIONAL_COMPARISON_OPERATORS)[number];

export function isSpreadsheetConditionalComparisonOperator(
  value: unknown,
): value is SpreadsheetConditionalComparisonOperator {
  return SPREADSHEET_CONDITIONAL_COMPARISON_OPERATORS.some(
