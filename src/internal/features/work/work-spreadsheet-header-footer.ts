...
export type EffectiveSpreadsheetHeaderFooterSections =
  Required<WorkSpreadsheetHeaderFooterSections>;
...
export function hasSpreadsheetHeaderFooterSections(
  sections: WorkSpreadsheetHeaderFooterSections | undefined,
): boolean {
...
export function resolveSpreadsheetHeaderFooterTemplate(
  ...
  const values: Record<
    (typeof SPREADSHEET_HEADER_FOOTER_TOKENS)[number],
    string
  > = {
