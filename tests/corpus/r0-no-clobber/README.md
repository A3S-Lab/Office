...
1. Import → light/no-op edit path → export → reopen does not silently drop
   ...
   fields, XE/INDEX index identities, TOC options/entries, table cells).
...
bookmark-backed PAGEREF, NUMPAGES, SECTION, SECTIONPAGES, and NUMWORDS
...
identity diagnostics, and active-content fail-closed export.
