...
test('validates exact native scale, spacing, kerning, emphasis, and position ranges', () => {
  const draft = createDocumentFontDialogDraft({
    ...
    openTypeLigatures: { mixed: false, value: null },
    openTypeNumberForm: { mixed: false, value: null },
    openTypeNumberSpacing: { mixed: false, value: null },
    openTypeStylisticSets: { mixed: false, value: null },
    openTypeContextualAlternates: { mixed: false, value: null },
    fontFamily: null,
    fontSize: null,
