...
function createEditor(): Editor {
  return new Editor({
    ...
    content: [
      ...
      '<strong><span data-office-character-scale-percent="80" data-office-character-position-half-points="4" data-office-character-spacing-twips="30" data-office-kerning-threshold-half-points="24" style="font-stretch: 80%; --work-document-character-position: 2pt; color: #0070c0; font-family: Arial, sans-serif; font-size: 14pt; letter-spacing: 1.5pt; font-kerning: normal">Source</span></strong>',
      '</h2>',
