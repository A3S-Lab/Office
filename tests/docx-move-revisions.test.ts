...
describe('DOCX move revisions', () => {
  ...
  test('admits attributed footnoteRef glyphs inside move revisions', () => {
    const document = parseXml(`
      <w:document xmlns:w="${WORD_NAMESPACE}">
        <w:body>
          <w:p>
  ...
  test('admits attributed endnoteRef glyphs inside move revisions', () => {
    const document = parseXml(`
      <w:document xmlns:w="${WORD_NAMESPACE}">
        <w:body>
          <w:p>
            <w:moveFrom w:id="283" w:author="Ada" w:date="2026-09-01T00:00:00Z">
              <w:r><w:delText>old</w:delText><w:endnoteRef w:val="1"/><w:delText>line</w:delText></w:r>
            </w:moveFrom>
          </w:p>
          <w:p>
            <w:moveTo w:id="283" w:author="Ada" w:date="2026-09-01T00:00:00Z">
              <w:r><w:t>old</w:t><w:endnoteRef w:val="1"/><w:t>line</w:t></w:r>
            </w:moveTo>
          </w:p>
        </w:body>
      </w:document>
  ...
  test('admits attributed annotationRef glyphs inside move revisions', () => {
    const document = parseXml(`
      <w:document xmlns:w="${WORD_NAMESPACE}">
        <w:body>
          <w:p>
            <w:moveFrom w:id="284" w:author="Ada" w:date="2026-09-01T00:00:00Z">
              <w:r><w:delText>old</w:delText><w:annotationRef w:val="1"/><w:delText>line</w:delText></w:r>
            </w:moveFrom>
          </w:p>
          <w:p>
            <w:moveTo w:id="284" w:author="Ada" w:date="2026-09-01T00:00:00Z">
              <w:r><w:t>old</w:t><w:annotationRef w:val="1"/><w:t>line</w:t></w:r>
            </w:moveTo>
          </w:p>
        </w:body>
      </w:document>
  ...
  test('admits endnoteReference with id inside move revisions', () => {
    const document = parseXml(`
      <w:document xmlns:w="${WORD_NAMESPACE}">
        <w:body>
          <w:p>
            <w:moveFrom w:id="282" w:author="Ada" w:date="2026-09-01T00:00:00Z">
              <w:r><w:delText>old</w:delText><w:endnoteReference w:id="2"/><w:delText>line</w:delText></w:r>
            </w:moveFrom>
          </w:p>
          <w:p>
            <w:moveTo w:id="282" w:author="Ada" w:date="2026-09-01T00:00:00Z">
              <w:r><w:t>old</w:t><w:endnoteReference w:id="2"/><w:t>line</w:t></w:r>
            </w:moveTo>
          </w:p>
        </w:body>
      </w:document>
  ...
  test('imports companion move-range bookmarks around a two-level nested table move', () => {
    const document = parseXml(`
      <w:document xmlns:w="${WORD_NAMESPACE}">
        <w:body>
          <w:moveFromRangeStart w:id="0" w:author="Ada" w:date="2026-09-01T00:00:00Z" w:name="move0"/>
    ...
    expect(descendants(document, 'moveFromRangeStart')).toHaveLength(0);
    expect(descendants(document, 'tbl')).toHaveLength(3);
  });

  test('rejects companion move-range bookmarks that sandwich three-level nested tables', () => {
    const document = parseXml(`
      <w:document xmlns:w="${WORD_NAMESPACE}">
        <w:body>
          <w:moveFromRangeStart w:id="0" w:author="Ada" w:date="2026-09-01T00:00:00Z" w:name="move0"/>
  ...
  test('imports companion move-range bookmarks around an SDT with a two-level nested table', () => {
    const document = parseXml(`
      <w:document xmlns:w="${WORD_NAMESPACE}">
        <w:body>
          <w:moveFromRangeStart w:id="0" w:author="Ada" w:date="2026-09-01T00:00:00Z" w:name="move0"/>
  ...
  test('rejects companion move-range bookmarks that sandwich an SDT with three-level nested tables', () => {
    const document = parseXml(`
      <w:document xmlns:w="${WORD_NAMESPACE}">
        <w:body>
          <w:moveFromRangeStart w:id="0" w:author="Ada" w:date="2026-09-01T00:00:00Z" w:name="move0"/>
