...
describe('DOCX paragraph-break merge/split revisions', () => {
  ...
  test('admits empty footnoteRef glyphs in paragraph-break bodies', () => {
    const document = parseXml(`
      <w:document xmlns:w="${WORD_NAMESPACE}">
        <w:body>
          <w:p>
            <w:pPr><w:rPr>
              <w:del w:id="36" w:author="Ada" w:date="2026-09-05T01:00:00Z"/>
            </w:rPr></w:pPr>
            <w:r>
              <w:t>Alpha</w:t><w:footnoteRef/><w:t>mark</w:t>
            </w:r>
          </w:p>
          <w:p>
            <w:r><w:t>Bravo</w:t><w:footnoteRef/><w:t>next</w:t></w:r>
          </w:p>
        </w:body>
      </w:document>
    `);
    ...
    const document = parseXml(`
      <w:document xmlns:w="${WORD_NAMESPACE}">
        <w:body>
          <w:p>
            <w:pPr><w:rPr>
              <w:del w:id="361" w:author="Ada" w:date="2026-09-05T01:00:00Z"/>
            </w:rPr></w:pPr>
            <w:r>
              <w:t>Alpha</w:t><w:footnoteReference w:id="2"/><w:t>mark</w:t>
            </w:r>
          </w:p>
          <w:p>
            <w:r><w:t>Bravo</w:t><w:footnoteReference w:id="2"/><w:t>next</w:t></w:r>
          </w:p>
        </w:body>
      </w:document>
    `);
  ...
  test('admits endnoteReference with id in paragraph-break bodies', () => {
    const document = parseXml(`
      <w:document xmlns:w="${WORD_NAMESPACE}">
        <w:body>
          <w:p>
            <w:pPr><w:rPr>
              <w:del w:id="362" w:author="Ada" w:date="2026-09-05T01:00:00Z"/>
            </w:rPr></w:pPr>
            <w:r>
              <w:t>Alpha</w:t><w:endnoteReference w:id="2"/><w:t>mark</w:t>
            </w:r>
          </w:p>
          <w:p>
            <w:r><w:t>Bravo</w:t><w:endnoteReference w:id="2"/><w:t>next</w:t></w:r>
          </w:p>
        </w:body>
      </w:document>
    `);
  ...
  test('admits empty endnoteRef glyphs in paragraph-break bodies', () => {
    const document = parseXml(`
      <w:document xmlns:w="${WORD_NAMESPACE}">
        <w:body>
          <w:p>
            <w:pPr><w:rPr>
              <w:del w:id="37" w:author="Ada" w:date="2026-09-05T01:00:00Z"/>
            </w:rPr></w:pPr>
            <w:r>
              <w:t>Alpha</w:t><w:endnoteRef/><w:t>mark</w:t>
            </w:r>
          </w:p>
          <w:p>
            <w:r><w:t>Bravo</w:t><w:endnoteRef/><w:t>next</w:t></w:r>
          </w:p>
        </w:body>
      </w:document>
    `);
  ...
  test('admits empty separator glyphs in paragraph-break bodies', () => {
    const document = parseXml(`
      <w:document xmlns:w="${WORD_NAMESPACE}">
        <w:body>
          <w:p>
            <w:pPr><w:rPr>
              <w:del w:id="39" w:author="Ada" w:date="2026-09-05T01:00:00Z"/>
            </w:rPr></w:pPr>
            <w:r>
              <w:t>Alpha</w:t><w:separator/><w:t>mark</w:t>
            </w:r>
          </w:p>
          <w:p>
            <w:r><w:t>Bravo</w:t><w:separator/><w:t>next</w:t></w:r>
          </w:p>
        </w:body>
      </w:document>
    `);
  ...
  test('admits empty continuationSeparator glyphs in paragraph-break bodies', () => {
    const document = parseXml(`
      <w:document xmlns:w="${WORD_NAMESPACE}">
        <w:body>
          <w:p>
            <w:pPr><w:rPr>
              <w:del w:id="40" w:author="Ada" w:date="2026-09-05T01:00:00Z"/>
            </w:rPr></w:pPr>
            <w:r>
              <w:t>Alpha</w:t><w:continuationSeparator/><w:t>mark</w:t>
            </w:r>
          </w:p>
          <w:p>
            <w:r><w:t>Bravo</w:t><w:continuationSeparator/><w:t>next</w:t></w:r>
          </w:p>
        </w:body>
      </w:document>
    `);
