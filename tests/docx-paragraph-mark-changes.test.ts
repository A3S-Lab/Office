...
describe('DOCX paragraph-mark revisions', () => {
  ...
  test('admits empty carriage-return glyphs inside whole-paragraph mark revisions', () => {
    const document = wordXml(`
      <w:p>
        <w:pPr><w:rPr>
          <w:ins w:id="47" w:author="Ada Reviewer" w:date="2026-09-05T01:00:00Z"/>
        </w:rPr></w:pPr>
        <w:ins w:id="48" w:author="Ada Reviewer" w:date="2026-09-05T01:00:00Z">
          <w:r>
            <w:t>Left</w:t><w:cr/><w:t>Right</w:t>
          </w:r>
        </w:ins>
      </w:p>
    `);
    ...
    expect(markDocxParagraphMarkChanges(document).paragraphs).toEqual([
      expect.objectContaining({
        id: 'docx-paragraph-mark-change-47',
        kind: 'insertion',
      }),
    ]);
  });

  test('rejects attributed carriage-return glyphs inside whole-paragraph mark revisions', () => {
    const document = wordXml(`
      <w:p>
        <w:pPr><w:rPr>
          <w:ins w:id="49" w:author="Ada Reviewer" w:date="2026-09-05T01:00:00Z"/>
        </w:rPr></w:pPr>
        <w:ins w:id="50" w:author="Ada Reviewer" w:date="2026-09-05T01:00:00Z">
          <w:r><w:t>Left</w:t><w:cr w:val="1"/><w:t>Right</w:t></w:r>
        </w:ins>
      </w:p>
    `);
    const mark = descendants(document, 'ins').find(
  ...
  test('admits empty lastRenderedPageBreak glyphs inside whole-paragraph mark revisions', () => {
    const document = wordXml(`
      <w:p>
        <w:pPr><w:rPr>
        ...
        <w:ins w:id="54" w:author="Ada Reviewer" w:date="2026-09-05T01:00:00Z">
          <w:r>
            <w:t>Left</w:t><w:lastRenderedPageBreak/><w:t>Right</w:t>
          </w:r>
        </w:ins>
      </w:p>
    `);
  ...
  test('rejects attributed lastRenderedPageBreak glyphs inside whole-paragraph mark revisions', () => {
    const document = wordXml(`
      <w:p>
        <w:pPr><w:rPr>
          <w:ins w:id="55" w:author="Ada Reviewer" w:date="2026-09-05T01:00:00Z"/>
        </w:rPr></w:pPr>
        <w:ins w:id="56" w:author="Ada Reviewer" w:date="2026-09-05T01:00:00Z">
          <w:r><w:t>Left</w:t><w:lastRenderedPageBreak w:val="1"/><w:t>Right</w:t></w:r>
        </w:ins>
      </w:p>
    `);
    const mark = descendants(document, 'ins').find(
  ...
  test('admits empty page-number and date-field glyphs inside whole-paragraph mark revisions', () => {
    const document = wordXml(`
      <w:p>
        <w:pPr><w:rPr>
          <w:ins w:id="57" w:author="Ada Reviewer" w:date="2026-09-05T01:00:00Z"/>
        </w:rPr></w:pPr>
        <w:ins w:id="58" w:author="Ada Reviewer" w:date="2026-09-05T01:00:00Z">
          <w:r>
            <w:t>Left</w:t><w:pgNum/><w:dayLong/><w:monthLong/><w:yearLong/><w:t>Right</w:t>
          </w:r>
        </w:ins>
      </w:p>
    `);
    ...
    expect(markDocxParagraphMarkChanges(document).paragraphs).toEqual([
      expect.objectContaining({
        id: 'docx-paragraph-mark-change-57',
        kind: 'insertion',
      }),
    ]);
  });

  test('rejects attributed page-number glyphs inside whole-paragraph mark revisions', () => {
    const document = wordXml(`
      <w:p>
        <w:pPr><w:rPr>
          <w:ins w:id="59" w:author="Ada Reviewer" w:date="2026-09-05T01:00:00Z"/>
        </w:rPr></w:pPr>
        <w:ins w:id="60" w:author="Ada Reviewer" w:date="2026-09-05T01:00:00Z">
          <w:r><w:t>Left</w:t><w:pgNum w:val="1"/><w:t>Right</w:t></w:r>
        </w:ins>
      </w:p>
    `);
    const mark = descendants(document, 'ins').find(
  ...
  test('admits footnoteReference with id inside whole-paragraph mark revisions', () => {
    ...
    expect(markDocxParagraphMarkChanges(document).paragraphs).toEqual([
      expect.objectContaining({
        id: 'docx-paragraph-mark-change-69',
        kind: 'insertion',
      }),
    ]);
  });

  test('admits endnoteReference with id inside whole-paragraph mark revisions', () => {
    const document = wordXml(`
      <w:p>
        <w:pPr><w:rPr>
          <w:ins w:id="691" w:author="Ada Reviewer" w:date="2026-09-05T01:00:00Z"/>
        </w:rPr></w:pPr>
        <w:ins w:id="701" w:author="Ada Reviewer" w:date="2026-09-05T01:00:00Z">
          <w:r><w:t>Left</w:t><w:endnoteReference w:id="2"/><w:t>Right</w:t></w:r>
        </w:ins>
      </w:p>
    `);
    const mark = descendants(document, 'ins').find(
    ...
    expect(markDocxParagraphMarkChanges(document).paragraphs).toEqual([
      expect.objectContaining({
        id: 'docx-paragraph-mark-change-691',
        kind: 'insertion',
      }),
    ]);
  });

  test('rejects malformed footnoteReference glyphs inside whole-paragraph mark revisions', () => {
    const document = wordXml(`
      <w:p>
        <w:pPr><w:rPr>
          <w:ins w:id="692" w:author="Ada Reviewer" w:date="2026-09-05T01:00:00Z"/>
        </w:rPr></w:pPr>
        <w:ins w:id="702" w:author="Ada Reviewer" w:date="2026-09-05T01:00:00Z">
          <w:r><w:t>Left</w:t><w:footnoteReference w:id="2" w:customMarkFollows="1"/><w:t>Right</w:t></w:r>
        </w:ins>
      </w:p>
    `);
    const mark = descendants(document, 'ins').find(
  ...
  test('admits empty endnoteRef glyphs inside whole-paragraph mark revisions', () => {
    const document = wordXml(`
      <w:p>
        <w:pPr><w:rPr>
        ...
        <w:ins w:id="72" w:author="Ada Reviewer" w:date="2026-09-05T01:00:00Z">
          <w:r>
            <w:t>Left</w:t><w:endnoteRef/><w:t>Right</w:t>
          </w:r>
        </w:ins>
      </w:p>
    `);
    ...
    expect(markDocxParagraphMarkChanges(document).paragraphs).toEqual([
      expect.objectContaining({
        id: 'docx-paragraph-mark-change-71',
        kind: 'insertion',
      }),
    ]);
  });
  ...
  test('admits attributed endnoteRef glyphs inside whole-paragraph mark revisions', () => {
    const document = wordXml(`
      <w:p>
        <w:pPr><w:rPr>
          <w:ins w:id="73" w:author="Ada Reviewer" w:date="2026-09-05T01:00:00Z"/>
        </w:rPr></w:pPr>
        <w:ins w:id="74" w:author="Ada Reviewer" w:date="2026-09-05T01:00:00Z">
          <w:r><w:t>Left</w:t><w:endnoteRef w:val="1"/><w:t>Right</w:t></w:r>
        </w:ins>
      </w:p>
    `);
    const mark = descendants(document, 'ins').find(
  ...
  test('rejects malformed endnoteReference glyphs inside whole-paragraph mark revisions', () => {
    const document = wordXml(`
      <w:p>
        <w:pPr><w:rPr>
          <w:ins w:id="75" w:author="Ada Reviewer" w:date="2026-09-05T01:00:00Z"/>
        </w:rPr></w:pPr>
        <w:ins w:id="76" w:author="Ada Reviewer" w:date="2026-09-05T01:00:00Z">
          <w:r><w:t>Left</w:t><w:endnoteReference w:id="2" w:customMarkFollows="1"/><w:t>Right</w:t></w:r>
        </w:ins>
      </w:p>
    `);
    const mark = descendants(document, 'ins').find(
  ...
  test('admits empty annotationRef glyphs inside whole-paragraph mark revisions', () => {
    const document = wordXml(`
      <w:p>
        <w:pPr><w:rPr>
          <w:ins w:id="77" w:author="Ada Reviewer" w:date="2026-09-05T01:00:00Z"/>
        </w:rPr></w:pPr>
        <w:ins w:id="78" w:author="Ada Reviewer" w:date="2026-09-05T01:00:00Z">
          <w:r>
            <w:t>Left</w:t><w:annotationRef/><w:t>Right</w:t>
          </w:r>
        </w:ins>
      </w:p>
    `);
    ...
    expect(markDocxParagraphMarkChanges(document).paragraphs).toEqual([
      expect.objectContaining({
        id: 'docx-paragraph-mark-change-77',
        kind: 'insertion',
      }),
    ]);
  });
  ...
  test('admits attributed annotationRef glyphs inside whole-paragraph mark revisions', () => {
    const document = wordXml(`
      <w:p>
        <w:pPr><w:rPr>
          <w:ins w:id="79" w:author="Ada Reviewer" w:date="2026-09-05T01:00:00Z"/>
        </w:rPr></w:pPr>
  ...
  test('admits empty separator glyphs inside whole-paragraph mark revisions', () => {
    const document = wordXml(`
      <w:p>
        <w:pPr><w:rPr>
          <w:ins w:id="103" w:author="Ada Reviewer" w:date="2026-09-05T01:00:00Z"/>
        </w:rPr></w:pPr>
        <w:ins w:id="104" w:author="Ada Reviewer" w:date="2026-09-05T01:00:00Z">
          <w:r>
            <w:t>Left</w:t><w:separator/><w:t>Right</w:t>
          </w:r>
        </w:ins>
      </w:p>
    `);
    ...
    expect(markDocxParagraphMarkChanges(document).paragraphs).toEqual([
      expect.objectContaining({
        id: 'docx-paragraph-mark-change-103',
        kind: 'insertion',
      }),
    ]);
  });

  test('rejects attributed separator glyphs inside whole-paragraph mark revisions', () => {
    const document = wordXml(`
      <w:p>
        <w:pPr><w:rPr>
          <w:ins w:id="105" w:author="Ada Reviewer" w:date="2026-09-05T01:00:00Z"/>
        </w:rPr></w:pPr>
        <w:ins w:id="106" w:author="Ada Reviewer" w:date="2026-09-05T01:00:00Z">
          <w:r><w:t>Left</w:t><w:separator w:val="1"/><w:t>Right</w:t></w:r>
        </w:ins>
      </w:p>
    `);
    const mark = descendants(document, 'ins').find(
  ...
  test('admits empty continuationSeparator glyphs inside whole-paragraph mark revisions', () => {
    const document = wordXml(`
      <w:p>
        <w:pPr><w:rPr>
          <w:ins w:id="107" w:author="Ada Reviewer" w:date="2026-09-05T01:00:00Z"/>
        </w:rPr></w:pPr>
        <w:ins w:id="108" w:author="Ada Reviewer" w:date="2026-09-05T01:00:00Z">
          <w:r>
            <w:t>Left</w:t><w:continuationSeparator/><w:t>Right</w:t>
          </w:r>
        </w:ins>
      </w:p>
    `);
    ...
    expect(markDocxParagraphMarkChanges(document).paragraphs).toEqual([
      expect.objectContaining({
        id: 'docx-paragraph-mark-change-107',
        kind: 'insertion',
      }),
    ]);
  });

  test('rejects attributed continuationSeparator glyphs inside whole-paragraph mark revisions', () => {
    const document = wordXml(`
      <w:p>
        <w:pPr><w:rPr>
          <w:ins w:id="109" w:author="Ada Reviewer" w:date="2026-09-05T01:00:00Z"/>
        </w:rPr></w:pPr>
        <w:ins w:id="110" w:author="Ada Reviewer" w:date="2026-09-05T01:00:00Z">
          <w:r><w:t>Left</w:t><w:continuationSeparator w:val="1"/><w:t>Right</w:t></w:r>
        </w:ins>
      </w:p>
    `);
    const mark = descendants(document, 'ins').find(
