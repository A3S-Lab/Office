...
workflow; Presentation focus recovery across object cut and paste; and the
public Playground-to-docs navigation contract. Each suite owns only its
browser surface. Keep the preview process under the terminal that started it
and stop that process separately when testing is complete.
