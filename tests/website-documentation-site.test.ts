...
test('keeps public documentation on the neutral Traditional Office baseline', async () => {
  ...
  const wpsReferenceDocumentation = new Set(
    [
      ...
      'docs/latest/en/automation/index.mdx',
      'docs/latest/zh/automation/index.mdx',
      'docs/latest/en/components/document.mdx',
      'docs/latest/zh/components/document.mdx',
      'docs/0.60.0/en/index.mdx',
      'docs/0.60.0/zh/index.mdx',
      'docs/0.60.0/en/automation/index.mdx',
      'docs/0.60.0/zh/automation/index.mdx',
      'docs/0.60.0/en/components/document.mdx',
      'docs/0.60.0/zh/components/document.mdx',
      'docs/0.59.0/en/index.mdx',
      'docs/0.59.0/zh/index.mdx',
      'docs/0.59.0/en/automation/index.mdx',
      'docs/0.59.0/zh/automation/index.mdx',
      'docs/0.59.0/en/components/document.mdx',
      'docs/0.59.0/zh/components/document.mdx',
      'docs/0.58.0/en/index.mdx',
      'docs/0.58.0/zh/index.mdx',
      'docs/0.58.0/en/automation/index.mdx',
      'docs/0.58.0/zh/automation/index.mdx',
      'docs/0.58.0/en/components/document.mdx',
      'docs/0.58.0/zh/components/document.mdx',
      ...
      'docs/0.56.1/zh/automation/index.mdx',
      'docs/0.56.1/en/components/document.mdx',
      'docs/0.56.1/zh/components/document.mdx',
      'docs/0.56.0/en/index.mdx',
      'docs/0.56.0/zh/index.mdx',
      'docs/0.56.0/en/automation/index.mdx',
      'docs/0.56.0/zh/automation/index.mdx',
      'docs/0.56.0/en/components/document.mdx',
      'docs/0.56.0/zh/components/document.mdx',
      'docs/0.55.0/en/index.mdx',
      'docs/0.55.0/zh/index.mdx',
      'docs/0.55.0/en/automation/index.mdx',
      'docs/0.55.0/zh/automation/index.mdx',
      'docs/0.55.0/en/components/document.mdx',
      'docs/0.55.0/zh/components/document.mdx',
      'docs/0.54.1/en/index.mdx',
      'docs/0.54.1/zh/index.mdx',
      'docs/0.54.1/en/automation/index.mdx',
      'docs/0.54.1/zh/automation/index.mdx',
      'docs/0.54.1/en/components/document.mdx',
      'docs/0.54.1/zh/components/document.mdx',
      'docs/0.54.0/en/index.mdx',
      'docs/0.54.0/zh/index.mdx',
      'docs/0.54.0/en/automation/index.mdx',
      'docs/0.54.0/zh/automation/index.mdx',
      'docs/0.54.0/en/components/document.mdx',
      'docs/0.54.0/zh/components/document.mdx',
      'docs/0.53.1/en/index.mdx',
      'docs/0.53.1/zh/index.mdx',
      'docs/0.53.1/en/components/document.mdx',
      'docs/0.53.1/zh/components/document.mdx',
  ...
  for (const file of [...repositoryDocumentation, ...versionedDocumentation]) {
    ...
    // all other public prose stays vendor-neutral. Release evidence may name
    // the installed WPS probe explicitly, so that product decision is not
    // mistaken for an unbounded vendor dependency.
    let neutralContents = nativeTextBoxDocumentation.has(file)
      ? contents.replace(/`wps:wsp`/gi, '')
      : contents;
    if (wpsReferenceDocumentation.has(file)) {
      neutralContents = neutralContents.replace(/\bwps\b/gi, '');
    }
...
test('routes the concise README and documentation homes to the current release story', async () => {
  ...
  expect(readme).toContain('Version `0.78.0`');
  expect(readme).toContain('Writer Phase 0 no-clobber fidelity');
  expect(readme).toContain('registerWorkPdfCjkFont');
  expect(readme).toContain('Earlier releases stay on the product');
  expect(englishHome).toContain("## What's new on `main` (0.78.0)");
  expect(englishHome).toContain('registerWorkPdfCjkFont');
  expect(chineseHome).toContain('## `main` 更新内容（0.78.0）');
  expect(chineseHome).toContain('registerWorkPdfCjkFont');
...
test('publishes the WPS VML connector boundary across code, docs, and A3S Test evidence', async () => {
  const [
    latestEnglish,
    latestChinese,
    frozenEnglish,
    ...
    readFile(
      path.join(documentationRoot, '0.54.0/en/components/document.mdx'),
      'utf8',
    ),
    readFile(
      path.join(documentationRoot, '0.54.0/zh/components/document.mdx'),
      'utf8',
    ),
    ...
    readFile(
      path.join(repositoryRoot, 'tests/document-connector-diagnostics.test.ts'),
      'utf8',
    ),
    readFile(
      path.join(repositoryRoot, 'tests/e2e/word-wps-connector-boundary.acl'),
      'utf8',
    ),
    readFile(path.join(repositoryRoot, 'package.json'), 'utf8'),
  ]);

  for (const document of [latestEnglish, frozenEnglish]) {
    expect(document).toContain('docx.connectors');
    expect(document).toContain('o:spt="32"');
    expect(document).toContain('word-wps-connector-boundary.acl');
  }
  for (const document of [latestChinese, frozenChinese]) {
    expect(document).toContain('docx.connectors');
    expect(document).toContain('o:spt="32"');
    expect(document).toContain('word-wps-connector-boundary.acl');
  }
  expect(changelog).toContain('## 0.54.0 - 2026-09-05');
  ...
  expect(packageManifest).toContain('"version": "0.78.0"');
});
...
test('publishes Writer connector arrow-style parity across the current and frozen release', async () => {
  ...
  for (const document of [
    ...
    expect(document).toContain('a:headEnd');
    expect(document).toContain('startarrow');
    expect(document).toContain('classic');
  }
...
test('publishes the WPS connector-kind A3S Test matrix in the 0.57.0 release story', async () => {
  ...
  for (const document of [latestEnglish, latestChinese]) {
    ...
    expect(document).toContain('0.78.0');
  }
...
test('publishes Writer move revisions across implementation, native collaboration, docs, and release evidence', async () => {
  ...
  expect(packageManifest).toContain('0.78.0');
});
