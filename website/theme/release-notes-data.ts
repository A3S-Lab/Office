export const OFFICE_RELEASE_NOTES: readonly OfficeReleaseNote[] = [
  {
    ...
    highlights: [
      ...
      },
      {
        ...
        detail: {
          en: 'Broader table property sets remain opaque metadata or fail-closed; opaque table fixtures stay on tblBorders.',
          zh: '更广的表属性集仍为不透明元数据或失败闭合；不透明表夹具仍为 tblBorders。',
        },
      },
    ],
    links: [
